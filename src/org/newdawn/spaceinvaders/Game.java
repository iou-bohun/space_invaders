...
public class Game extends Canvas {
    private final long coolTime = 3000;
    int timer;
    int timeCheck;
    int min = 0;
    int second = 0;
    ...
    private final Entity[] bossHpUi = new Entity[150];
    private final Entity[] playerHpUI = new Entity[10];
    private Entity obstacle;
    private Entity bossHpBar;
    private Entity alien;

    private final Entity[] itemUi = new Entity[4];
    ...
    private final long lastAddRoundUI = 0;
    private long lastUseHealPotion = 0;
    /**
     * The interval between our players shot (ms)
     */
    private final long firingInterval = 200;
    /**
    ...
    public void gameLoop() {
        ...
        if (glp.gameState == glp.inGameState) {
            while (gameRunning) {
                ...
                switch (stage) {
                    case 1:
                        g.drawImage(round1, 0, 0, null);
                        break;
                    case 2:
                        g.drawImage(round2, 0, 0, null);
                        break;
                    case 3:
                        g.drawImage(round3, 0, 0, null);
                        break;
                    case 4:
                        g.drawImage(round4, 0, 0, null);
                        break;
                    case 5:
                        g.drawImage(round5, 0, 0, null);
                        break;
                }
                ...
                gi.drawString(min + ":" + second, 377, 35);
