...
public class MainUI extends JPanel {
    ...
    public void loadTitleImg() {
        try {
            ...
            //상점 이미지 로딩
            InputStream is6 = new BufferedInputStream(Files.newInputStream(Paths.get("ui/coin.png")));
            coinImg = ImageIO.read(is6);
            InputStream is7 = new BufferedInputStream(Files.newInputStream(Paths.get("ui/heal_potion.png")));
            healPotion = ImageIO.read(is7);
            InputStream is8 = new BufferedInputStream(Files.newInputStream(Paths.get("ui/speed_potion.png")));
            speedPotion = ImageIO.read(is8);
            InputStream is9 = new BufferedInputStream(Files.newInputStream(Paths.get("ui/hard_ship.png")));
            hardShip = ImageIO.read(is9);
            InputStream is10 = new BufferedInputStream(Files.newInputStream(Paths.get("ui/lucky_ship.png")));
